...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2020 at 05:27 PM
...
(1, 'C1', 'Status Bangunan Tinggal', '1', 0.25),
(2, 'C2', 'Status Lahan Tinggal', '1', 0.25),
(3, 'C3', 'Jenis Lantai Terluas', '1', 0.15),
(4, 'C4', 'Jenis Dinding ', '1', 0.2),
(5, 'C5', 'Kondisi Dinding', '0', 0.15),
(6, 'C6', 'Jenis Atap', '1', 0.2),
(7, 'C7', 'Kondisi Atap', '0', 0.15),
(8, 'C8', 'Sumber Air Minum', '1', 0.3),
(9, 'C9', 'Sumber Penerangan', '1', 0.35);
...
(1, 'Kristina', 'kristina12@gmail.com', 'kristina', '21232f297a57a5a743894a0e4a801fc3', 1),
(2, 'Agus Dwi Waluyo', 'agusdwiwaluyo@gmail.com', 'agusdw', '0cfa66469d25bd0d9e55d7ba583f9f2f', 2);
...
INSERT INTO `tb_warga` (`id_warga`, `nama_alternatif`, `status_bangunan_tinggal`, `status_lahan_tinggal`, `jenis_lantai_terluas`, `jenis_dinding`, `kondisi_dinding`, `jenis_atap`, `kondisi_atap`, `sumber_air_minum`, `sumber_penerangan`) VALUES
