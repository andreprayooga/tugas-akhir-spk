            ...
            <div class="table-responsive">
                <?php if ($this->session->userdata('fk_id_level') == '1') : ?>
                    ...
                    <div class="float-right">
                        <a class="btn btn-sm btn-success mb-2 mr-auto" href="<?php echo base_url('warga/export_excel'); ?>"><i class="fa fa-file-excel"></i> Export Excel</a>
                        <a class="btn btn-sm btn-danger mb-2 mr-auto" href="<?php echo base_url('warga/export_pdf'); ?>"><i class="fa fa-file-pdf"></i> Export PDF</a>
                    </div>
                <?php endif; ?>
                    ...
                    <tbody>
                        <?php foreach ($data_warga as $key => $value) : ?>
                            <tr>
                                ...
                                <?php if ($this->session->userdata('fk_id_level') == '1') : ?>
                                    <td>
                                        <a href="#" onclick="detail_warga()" class="btn btn-sm btn-info"><i class="fa fa-info-circle"></i></a>
