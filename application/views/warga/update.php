...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h4 mb-4 text-gray-800">Update Data Warga</h1>

    <form action="<?php echo site_url('warga/update' . $data->id_warga); ?>" method="post">
        <div class="form-row">
            <div class="form-group col-md-2">
                <label for="nik">NIK</label>
                <input type="text" class="form-control" name="nik" id="nik" value="<?php echo $data->nik; ?>" placeholder="Masukkan NIK" readonly>
                <?php echo form_error('nik', '<small class="text-danger pl-3">', '</small>'); ?>
            </div>
            <div class="form-group col-md-3">
                <label for="nama_warga">Nama Warga</label>
                <input type="text" class="form-control" name="nama_warga" id="nama_warga" value="<?php echo $data->nama_warga; ?>" placeholder="Masukkan Nama Warga">
